  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl">
      <div className="flex flex-col items-center">
        <img src={assets.logo_icon} alt="" className="w-[min(10vw,200px)]" />
        <p className="text-white text-5xl">QuickChat</p>
      </div>
      <form onSubmit={onSubmitHandler}
        className="border-2 bg-white/8 text-white border-gray-600
      ...
      >
        ...
        <button
          type="submit"
          className="py-3 bg-gradient-to-r from-blue-400 to-blue-950/100  text-white rounded-md cursor-pointer "
        >
        ...
        <div className="flex flex-col gap-2">
          {currState === "Sign up" ? (
            ...
            <p className="text-sm text-gray-600">Create an account <span onClick={()=> setCurrentState("Sign up")} className="font-medium text-blue-950/100 cursor-pointer">Click here</span></p>
          )}
        </div>
      </form>
    </div>

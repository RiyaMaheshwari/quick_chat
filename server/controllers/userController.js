...
export const signUp = async (req, res) => {
  ...
  try {
    if (!fullName || !email || !password || !bio) {
      return res.json({ success: false, messase: "Missing details" });
    }
    ...
    // if user doestn't exist(store encrypted password into mongodb)
...
export const login = async (req, res) => {
  try {
    ...
    if (!isPasswordCorrect) {
      return res.json({ success: false, messase: "Invalid credentials" });
    }
